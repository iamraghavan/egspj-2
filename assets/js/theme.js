...
/**
   ...
   */
spyScroll:()=>{let e=document.querySelectorAll("section[id]"),t=document.querySelectorAll(".nav-link.scroll");window.onscroll=()=>{e.forEach((e=>{let o=window.scrollY,r=e.offsetTop-0,a=e.offsetHeight,n=e.getAttribute("id");//returns the number of pixels that the document is currently scrolled vertically.
//gets the value of an attribute of an element
o>=r&&o<r+a&&t.forEach((e=>{e.classList.remove("active"),document.querySelector(`.nav-link.scroll[href*=${n}]`).classList.add("active")}
...
var t=window.innerWidth-document.body.clientWidth,o=document.querySelectorAll(".modal"),r=document.querySelector(".navbar.fixed"),a=document.querySelector(".progress-wrap");o.forEach((e=>{e.addEventListener("show.bs.modal",(function(e){!function setPadding(){null!=r&&(r.style.paddingRight=t+"px"),null!=a&&(a.style.marginRight=t+"px")}()})),e.addEventListener("hidden.bs.modal",(function(e){!function removePadding(){null!=r&&(r.style.paddingRight=""),null!=a&&(a.style.marginRight="")}()}))}))},
/**
   * iTooltip
